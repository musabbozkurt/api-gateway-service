...
public class FirebaseConfig implements ResourceLoaderAware {
     ...
     * Example:
     * <pre>
     * firebase.apps.marketing-application=classpath:firebase/marketing-service-account.json
     * firebase.apps.meyvesebze-application={"type":"service_account","project_id":"...","private_key":"..."}
